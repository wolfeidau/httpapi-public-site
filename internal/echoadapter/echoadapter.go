...
func Handler(echolambda *EchoLambda) func(ctx context.Context, req events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
  return func(ctx context.Context, req events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {

    log.Info().Str("Path", req.Path).Str("RequestID", req.RequestContext.RequestID).Int("size", len(req.Body)).Msg("Processing request")
